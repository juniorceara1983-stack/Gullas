...
| **Estufa** | Controlar quantidades enviadas por data e por loja (**Loja PS** e **Loja Iande**), com visão **geral**, atualização manual (botão atualizar) e recarga automática após salvar envio de enviado/vendido/disponível |
